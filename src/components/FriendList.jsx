  ...
  return (
    ...
    <div>
           ...
           <div className=' bg-chat p-2 rounded-t-xl  flex items-center justify-between w-full top-0 left-0 sticky'>
              <h2 className='font-mono font-bold  text-xl capitalize ' >Friend List</h2>
            ...
            friendList.map((item,i)=>{
              return(
                ...
                <div className='flex gap-x-4 items-center px-2 py-2'>
                  ...
                  <button onClick={()=>handleUnFriend(item)} className='text-xs bg-quaternary  mt-2 md:mt-0 text-white font-serif  py-1 px-2 rounded' type='submit' >Unfriend </button>
                      <button onClick={()=>handelBlock(item)} className='text-xs bg-red-500 mt-2 md:mt-0 text-white font-serif  py-1 px-2 rounded' type='submit' >Block </button>
                  </div>
          </div>
              )
            })
